<div class="app-menu navbar-menu">
    ...
    <div class="brand-logo">
        <a href="{{route('admin.dashboard')}}" class="logo logo-light">
            <span class="logo-sm">
                <img src="{{show_image('assets/images/backend/AdminLogoIcon/'.$general->admin_logo_sm,file_path()['loder_logo']['size'])}}"
                    alt="{{@$general->admin_logo_sm}}">
            </span>

            <span class="logo-lg">
                <img src="{{show_image('assets/images/backend/AdminLogoIcon/'.$general->admin_logo_lg ,file_path()['admin_site_logo']['size'])}}"
                    alt="{{$general->admin_logo_lg}}">
    ...
    <div id="scrollbar" class="scroll-bar" data-simplebar>
        <div class="container-fluid">
            <ul class="navbar-nav" id="navbar-nav">
                ...
                permission_check('view_admin') || permission_check('view_roles') )
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link {{!request()->routeIs('admin.role.*') || !request()->routeIs('admin.index') || !request()->routeIs('admin.edit') || !request()->routeIs('admin.create') ?'collapsed' :''    }}"
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link
                            ...
                            " href="#sellermanage" data-bs-toggle="collapse" role="button" aria-expanded="false"
                        aria-controls="sellermanage">
                    ...
                    <div class="pt-1 collapse
                        ...
                        <ul class="nav nav-sm flex-column gap-1">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('admin.seller.info.*')?'active' :'' }}"
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('admin.plan.subscription')?'active' :'' }}  "
                                    href="{{route('admin.plan.subscription')}}">
                                    {{translate("Seller Subscription")}}
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('admin.plan.index')?'active' :'' }} "
                ...
                @if(permission_check('view_brand') || permission_check('view_categroy') ||
                permission_check('view_product') || permission_check('view_order') )
                <li class="menu-title">
                    <span>
                ...
                @if(permission_check('view_brand') || permission_check('view_categroy') ||
                permission_check('view_product') )
                <li class="nav-item">
                    <a class="nav-link   {{ !request()->routeIs('admin.item.*')?'collapsed' :'' }} menu-link"
                    ...
                    <div class="pt-1 collapse  {{request()->routeIs('admin.item.*') || request()->routeIs('admin.product.seller.*') || request()->routeIs('admin.digital.product.*') || request()->routeIs('admin.product.reviews') ?'show' :'' }} menu-dropdown mega-dropdown-menu"
                        id="inhouseProduct">
                        <ul class="nav nav-sm flex-column gap-1">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('admin.product.seller.*')?'active' :'' }}  "
                                    href="{{route('admin.product.seller.index')}}">

                                    {{translate("Seller Product")}}
                                    @if($seller_new_physical_product_count > 0)
                                    <span title="{{translate('Seller New Product')}}" data-bs-toggle="tooltip"
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.item.category.index')}}"
                                    class="{{request()->routeIs('admin.item.category.*')?'active' :'' }}  nav-link">
                                    {{translate("Category")}}
                                </a>
                            </li>
                            @endif
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.item.attribute.index')}}"
                                    class="{{request()->routeIs('admin.item.attribute.*')?'active' :'' }}  nav-link">
                                    {{translate("Attribute")}}
                                </a>
                            </li>
                            @endif
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.seller.order.index')}}"
                                    ...
                                    <span>
                                        ...
                                        <small title="{{translate('Seller Placed Order')}}" data-bs-toggle="tooltip"
                                            data-bs-placement="top" class="badge bg-danger ms-2">
                                    ...
                                    <ul class="nav nav-sm flex-column gap-1">
                                        ...
                                        <li class="nav-item">
                                            <a href="{{route('admin.digital.order.product.seller')}}"
                                                class=" {{request()->routeIs('admin.digital.order.product.seller') ? 'active' : '' }} nav-link">
                                                {{translate('Seller
                                                Order')}}
                                            </a>
                                        </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="pt-1 collapse  {{request()->routeIs('admin.report.*') || request()->routeIs('admin.payment.index') ||  request()->routeIs('admin.payment.*') || request()->routeIs('admin.withdraw.log.*')  ?'show' :''   }}   menu-dropdown"
                        id="userReport">
                        <ul class="nav nav-sm flex-column gap-1">
                ...
                @if(permission_check('manage_frontend') || permission_check('manage_blog') ||
                permission_check('manage_deal') || permission_check('manage_offer') || permission_check('manage_cuppon')
                || permission_check('manage_campaign') )
                <li class="menu-title">
                    <span>
                ...
                <li class="nav-item mt-1">
                    <a class="nav-link {{ !request()->routeIs('admin.frontend.promotional.*') || !request()->routeIs('admin.frontend.section.*') ?'collapsed' :''   }} menu-link"
                    ...
                    <div class="pt-1 collapse {{request()->routeIs('admin.frontend.section') || request()->routeIs('admin.menu.*') || request()->routeIs('admin.page.*') || request()->routeIs('admin.faq.*') ||  request()->routeIs('admin.frontend.testimonial.*') ||request()->routeIs('admin.blog.*') ||request()->routeIs('admin.home.category') ?'show' :''   }} menu-dropdown"
                        id="forntendSection">
                        <ul class="nav nav-sm flex-column gap-1">
                            <li class="nav-item">
                ...
                @if(permission_check('manage_deal') || permission_check('manage_offer') ||
                permission_check('manage_cuppon') || permission_check('manage_campaign') ||
                permission_check('manage_frontend') )
                <li class="nav-item">
                    <a class="nav-link {{ !request()->routeIs('admin.promote.*') || !request()->routeIs('admin.campaign.*') ?'collapsed' :''    }} menu-link"
                    ...
                    <div class="pt-1 collapse {{request()->routeIs('admin.promote.*') || request()->routeIs('admin.campaign.*') || request()->routeIs('admin.subscriber.*') || request()->routeIs('admin.contact.*') ?'show' :''    }} menu-dropdown"
                        id="managePromotion">
                        <ul class="nav nav-sm flex-column gap-1">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{request()->routeIs('admin.subscriber.*')?'active' :'' }}  "
                ...
                @if(permission_check('view_settings') || permission_check('view_languages') ||
                permission_check('view_method'))
                <li class="menu-title">
                    <span>
                ...
                <li class="nav-item mt-1">
                    <a class="nav-link {{ !request()->routeIs('admin.general.setting.*')? 'collapsed' :''}} menu-link"
                        ...
                        <ul class="nav nav-sm flex-column gap-1">
                            <li class="nav-item">
                                <a href="{{route('admin.general.setting.index')}}"
                                    class="{{request()->routeIs('admin.general.setting.index')? 'active' :''}}   nav-link">
                                    {{translate('System Setting')}}
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.seo.index')}}"
                                    class="{{request()->routeIs('admin.seo.index')? 'active' :''}}   nav-link">
                                    {{translate('SEO')}}
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link  {{request()->routeIs('admin.gateway.payment.*')?'active' :'' }}  "
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.notification.templates.index')}}"
                                    class="{{request()->routeIs('admin.notification.templates.*')? 'active' :''}}   nav-link">
                            ...
                            <li class="nav-item">
                                <a class="nav-link  {{!request()->routeIs('admin.mail.*') ? 'collapsed'  :''   }}  "
                            ...
                            <li class="nav-item">
                                <a class="nav-link  {{!request()->routeIs('admin.sms.*') ? 'collapsed'  :''   }}  "
                            ...
                            <li class="nav-item">
                                <a class="nav-link   {{request()->routeIs('admin.shipping.*') ?'collapsed' :''  }}"
                                    ...
                                    <ul class="nav nav-sm flex-column gap-1">
                                        <li class="nav-item">
                                            <a href="{{route('admin.shipping.method.index')}}"
                                                class=" {{request()->routeIs('admin.shipping.method.*') ?'active' :''  }}  nav-link">
                                                {{translate('Methods')}}
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a href="{{route('admin.shipping.delivery.index')}}"
                                                class="{{request()->routeIs('admin.shipping.delivery.*') ?'active':''  }}  nav-link">
                                                {{translate('Delivery')}}
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.general.setting.social.login')}}"
                                    class=" {{request()->routeIs('admin.general.setting.social.login')? 'active' :''}} nav-link">
                                    {{translate('Social Login')}}
                                </a>
                            </li>

                            <li class="nav-item">
                                <a href="{{route('admin.general.setting.plugin')}}"
                                    class=" {{request()->routeIs('admin.general.setting.plugin')? 'active' :''}} nav-link">
                                    {{translate('Plugin')}}
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.general.app.setting')}}"
                                    class=" {{request()->routeIs('admin.general.app.setting')? 'active' :''}} nav-link">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link {{ !request()->routeIs('admin.security.*')   ?'collapsed' :''  }}  "
                        href="#managaeSecurity" data-bs-toggle="collapse" role="button" aria-expanded="false"
                        aria-controls="managaeSecurity">
