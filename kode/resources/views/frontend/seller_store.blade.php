...
<div class="store-banner">
    <div class="shop-banner-img">
        <img src="{{show_image(file_path()['shop_first_image']['path'].'/'.@$seller->sellerShop->shop_first_image,file_path()['shop_first_image']['size'])}}"
            alt="{{$seller->sellerShop->shop_first_image}}">
    </div>
</div>
                ...
                <div class="section-title-tabs">
                    <ul class="nav section-title-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link title-tab-btn active store-active-title-tab" id="product-tab"
                                data-bs-toggle="tab" data-bs-target="#product" type="button" role="tab"
                                aria-controls="product" aria-selected="true">
                                {{translate("All Products")}}
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link title-tab-btn store-active-title-tab" id="digital-tab"
                                data-bs-toggle="tab" data-bs-target="#digital" type="button" role="tab"
                ...
                <div class="row g-2 g-md-4">
                    ...
                    <div class="col-lg-3 col-sm-4 col-6">
                        <div class="digital-product">
                            <a href="{{route('digital.product.details', [make_slug($product->name), $product->id])}}"
                                class="digital-product-img">
                            ...
                            <div class="digital-product-info">
                                ...
                                <div class="product-price py-3">
                                    <span>
                                        {{show_currency()}}{{short_amount($product->digitalProductAttribute?
                                        @$product->digitalProductAttribute->where('status','1')->first()->price:0)}}
                                    </span>
                                </div>
                        ...
                        <div class="trende-item-left">
                            ...
                            <div class="shop-btn">
                                <a href="{{route('seller.store.visit',[make_slug($seller->sellerShop->name), $seller->id])}}"
                                    class="wave-btn"><span><i class="fa-sharp fa-solid fa-cart-shopping"></i></span>
                                    {{translate('View Store')}}</a>
                            </div>
                        </div>
                        @if($seller->product)
                                ...
                                <li>
                                    <a href="{{route('product.details',[make_slug($product->name),$product->id])}}">
                                        <div class="trending-product-item">
                                            ...
                                            <div class="content">
                                                <h6><a
                                                        href="{{route('product.details',[make_slug($product->name),$product->id])}}">
                                                        {{$product->name}}
                                                    </a></h6>
