...
<div class="campaign-full-banner p-0">
    <img src="{{show_image(file_path()['flash_deal']['path'].'/'.$flashDeal->banner_image,file_path()['campaign_banner']['size'])}}"
        alt="{{@$campaign->banner_image}}">
</div>
                ...
                <div class="product-item">
                    <div class="product-img">
                        ...
                        {{-- <ul class="hover-action">
                            <li>
                                <a class="comparelist compare-btn wave-btn" data-product_id="{{$product->id}}"
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-action">
                            ...
                            <button data-product_id="{{$product->id}}" class="heart-btn  wishlistitem">
