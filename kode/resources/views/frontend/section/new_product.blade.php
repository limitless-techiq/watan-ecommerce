    ...
    <div class="Container">
        <div class="section-title">
            <div class="section-title-left">
                <div class="title-left-content">
                    <h3>{{@frontend_section_data($new_arrival->value,'heading')}} </h3>
                    <p>{{@frontend_section_data($new_arrival->value,'sub_heading')}}</p>
                </div>
            </div>
            <div class="section-title-right">
                <a href="{{route('new.product')}}" class="view-more-btn">
                    {{translate("View More")}}
                </a>
            </div>
        </div>
        ...
        <div class="individual-categories-items">
            <div class="slider-container">
                <div class="swiper new-arrival-slider swiper-container">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="priceAndRatting">
                                        <div class="product-price">
                                            ...
                                            @endif
                                            {{-- <p style="font-size: 12px; color: #f0c507;">{{ translate('Inclusive of
                                                taxes') }}</p> --}}
                                        </div>
                                    </div>
                                    ...
                                    <div class="product-action">
                                        ...
                                        <button data-product_id="{{$product->id}}" class="heart-btn wishlistitem"><i
                                                class="
                                                @if(in_array($product->id,$wishedProducts))
                                                    fa-solid
                                                @else
                                                    fa-regular
                                                @endif
                ...
                <button class="prev next-prev-btn newarrivals-prev">
                    <i class="fa-solid fa-arrow-left"></i>
                </button>
                <button class="next next-prev-btn newarrivals-next">
...
@if( @frontend_section_data($promo_banner->value,'position') == 'new-arrivals')
@includeWhen($promo_banner->status == '1', 'frontend.section.promotinal_banner', ['promo_banner' => $promo_banner])
@endif

@if( @frontend_section_data($promo_second_banner->value,'position') == 'new-arrivals')
