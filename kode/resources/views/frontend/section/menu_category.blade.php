            ...
            <div class="section-title">
                <div class="section-title-left">
                    <div class="title-left-content">
                        ...
                        <p>{{  $category->title ?  $category->title :@frontend_section_data($menu_category_section->value,'sub_heading')}}</p>
                    </div>
                </div>
                <div class="section-title-right">
                        <a href="{{{route('category.product', [make_slug(get_translation($category->category->name)),$category->category_id])}}}" class="view-more-btn">
                        {{translate('View More')}}
                        </a>
                </div>
            </div>
                ...
                <div class="slider-container">
                    ...
                    <div class="swiper individual-categories-slider-{{$category->id}} swiper-container">
                        <div class="swiper-wrapper">
                            @php
                                $products = App\Models\Product::with(['review','order','stock','stock.attribute'])->where('category_id', $category->category_id)->inhouseProduct()->whereIn('status',[0,1])->physical()->take(10)->get()
                            @endphp
                                ...
                                <div class="swiper-slide">
                                    <div class="product-item">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <h4 class="product-title"> <a href="{{route('product.details',[make_slug($product->name),$product->id])}}">{{$product->name}}</a></h4>
