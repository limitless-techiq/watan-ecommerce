        ...
        <div class="section-title">
            <div class="section-title-left">
                <div class="title-left-content">
                    <h3>{{@frontend_section_data($best_selling_section->value,'heading')}} </h3>
                    <p>{{@frontend_section_data($best_selling_section->value,'sub_heading')}}</p>
                </div>
            </div>
            <div class="section-title-right">
                <a href="{{route('best.product')}}" class="view-more-btn">
                    {{translate('View More')}}
                </a>
            </div>
                        ...
                        <div class="product-img">
                            ...
                            <div class="quick-view">
                                <button class="quick-view-btn quick--view--product" data-product_id="{{$product->id}}">
                                    <svg version="1.1" width="18" height="18" x="0" y="0" viewBox="0 0 519.644 519.644"
                                        xml:space="preserve">
                                        <g>
                                            <path
                            ...
                            {{-- <ul class="hover-action">
                                <li><a class="comparelist compare-btn wave-btn" data-product_id="{{$product->id}}"
                                        href="javascript:void(0)"><i class="fa-solid fa-code-compare"></i></a></li>
                            </ul> --}}
                                ...
                                <div class="product-price">
                                    ...
                                    <span>
                                        {{ show_currency() }}&nbsp;{{
                                            ...
                                            $product->stock->first() ? $product->stock->first()->price : $product->price),  2, '.', ',') }}
                                    ...
                                    @endif
                                    {{-- <p style="font-size: 12px; color: #f0c507;">{{translate('Inclusive of taxes')}}
                                    </p> --}}
                                </div>
                            </div>
