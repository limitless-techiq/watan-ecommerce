        ...
        <div class="row g-4">
            <div class="col-xl-3 col-lg-4 col-md-5">
                <div class="digital-product-banner sticky-side-div">
                    <img class="w-100"
                        src="{{show_image(file_path()['frontend']['path'].'/'.@frontend_section_data($digital_product_section->value,'image'),@frontend_section_data($digital_product_section->value,'image','size'))}}"
                        alt="digital-product-banner.jpg">
                </div>
            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-6">
                        <div class="digital-product">
                            <a href="{{route('digital.product.details', [make_slug($product->name), $product->id])}}"
                                ...
                                <img src="{{show_image(file_path()['product']['featured']['path'].'/'.$product->featured_image,file_path()['digital_product']['featured']['size'])}}"
                            ...
                            <div class="digital-product-info">
                                ...
                                <div class="d-flex justify-content-between align-items-center my-4">
                                    <div class="product-price">
                                        <span>
                                            {{ show_currency() }}{{
                                            number_format(short_amount($product->digitalProductAttribute ?
