...
<section class="pb-80">
    ...
    if($flag == 0){
    if($data->campaigns){
    if($data->price && $data->price !=null && Carbon\Carbon::now()->toDateTimeString() < $data->campaigns->end_time &&
        $data->campaigns->status == '1'){
                                    ...
                                    <ul class="nav nav-pills nav-justified custom-nav" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link p-3 wave-btn" id="pills-bill-address-tab"
                                                ...
                                                <svg version="1.1" x="0" y="0" viewBox="0 0 512 512"
                                                    xml:space="preserve">
                                                    <g>
                                                        <path
                                    ...
                                    <div class="tab-pane fade show active" id="pills-bill-info" role="tabpanel"
                                        ...
                                        <div>
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="address-card">
                                                            <div class="form-check card-radio">
                                                                <input id="{{$loop->index}}-address" type="radio"
                                                                    class="form-check-input checkout-radio-btn"
                                                                    value="{{$key}}" name="address_key" {{$loop->index
                                                                == 0 ? 'checked' :""}}>
                                                            ...
                                                            <div class="address-actions">
                                                                <a href="{{route('user.address.delete',$key)}}"
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-12">
                                                    <div>
                                                        ...
                                                        <textarea name="address" class="form-control user-info"
                                                            id="billinginfo-address" placeholder="Enter address"
                                                ...
                                                <div class="col-md-4">
                                                    <div>
                                                        ...
                                                        <input class="form-control user-info" type="text" id="zip"
                                                            name="zip"
                                                ...
                                                <div class="col-md-4">
                                                    <div>
                                                        ...
                                                        <input class="form-control user-info" type="text" id="city"
                                                            name="city"
                                                ...
                                                <div class="col-md-4">
                                                    <div>
                                                        ...
                                                        <input class="form-control user-info" type="text" id="state"
                                                            name="state"
                                                            value="{{old('state') ? old('state') :  @$user->address->state  }}"
                                            ...
                                            <div
                                                ...
                                                <button type="button" class="nexttab check-input btn-label  wave-btn"
                                        ...
                                        <div class="mt-4">
                                            <div class="row g-4">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-check card-radio">
                                                        <input
                                                            data-shipping_price="{{short_amount($shippingDelivery->price)}}"
                                                            id="{{$shippingDelivery->id}}" name="shipping_method"
                                                            type="radio"
                                                            class="form-check-input shiping-info checkout-radio-btn"
                                                            value="{{$shippingDelivery->id}}">
                                                        <label class="form-check-label pointer"
                                                            for="{{$shippingDelivery->id}}">
                                                            <span class="fs-16 float-end mt-3 text-wrap d-block">{{
                                                                show_currency() }}{{
                                                                number_format(short_amount($shippingDelivery->price), 2,
                                                                '.', ',') }}
                                    ...
                                    <div class="tab-pane fade" id="pills-payment" role="tabpanel"
                                        ...
                                        <div>
                                            ...
                                            <div class="row g-4">
                                                ...
                                                in_array($paymentMethod->id,$paymentOptions))
                                                <div class="col-xl-4 col-md-6">
                                                    <div class="form-check card-radio">
                                                        <input type="radio" id="payment-{{$paymentMethod->id}}"
                                                            name="payment_type" value="{{$paymentMethod->unique_code}}"
                                                ...
                                                <td class="text-start">
                                                    <div class="d-flex align-items-start gap-4 nowrap">
                                                        <div class="checkout-pro-img m-0">
                                                            <img class="m-0"
                                                                src="{{show_image(file_path()['product']['featured']['path'].'/'.$data->product->featured_image,file_path()['product']['featured']['size'])}}"
                                                        ...
                                                        <div class="check-item">
                                                            ...
                                                            <p class="text-muted fs-12 lh-1">
                                                                {{ show_currency() }}{{
                                                                number_format(short_amount($data->price), 2, '.', ',')
                                                                }} x {{$data->quantity}} ({{$data->attributes_value}})
                                                            </p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end nowrap">
                                                    {{ show_currency() }}{{ number_format(short_amount($data->total), 2,
                                                    '.', ',') }}
                                                </td>
                                            </tr>
                                            @php
                                ...
                                <ul>
                                    ...
                                    <li class="py-4 coupon-input">
                                        <div class="input-group">
                                            <input name="coupon_code" type="text" class="form-control border-2"
                                                placeholder="Enter your Coupon" aria-label="Enter your Coupon">
                                    ...
                                    <li class="d-flex align-items-center justify-content-between gap-4 subtotal">
                                        ...
                                        <span class="fw-semibold text-end pe-4 py-3  fs-14 nowrap"
                                            data-sub="{{$subTotal}}" id="subtotalamount">{{ show_currency() }}{{
                                            number_format($subTotal, 2, '.', ',') }}
                                        </span>
                                    </li>

                                    <li
                                        class="order-coupon-item d-flex align-items-center justify-content-between gap-4 @if(!session()->has('coupon')) d-none @endif">
                                    ...
                                    <li
                                        class="order-cost-item order-shipping-cost d-none d-flex align-items-center justify-content-between gap-4">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div>
                                ...
                                <input type="text" class="form-control " id="billinginfo-firstName" name="first_name"
                                    placeholder="{{translate('Enter first name')}}"
                                    value="{{old('first_name') ?  old('first_name') : @$user->name }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div>
                                ...
                                <input type="text" class="form-control " id="billinginfo-lastName" name="last_name"
                                    placeholder="{{translate('Enter last name')}}"
                                    value="{{old('phone')?old('phone') :@$user->last_name}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div>
                                ...
                                <input type="email" name="email" class="form-control" id="billinginfo-email"
                                    value="{{@$user->email ? $user->email : old('email')}}" placeholder="Enter email">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div>
                                ...
                                <input type="text" name="phone" class="form-control " id="billinginfo-phone"
                                    value="{{old('phone')?old('phone') :@$user->phone}}" placeholder="Enter phone no.">
                            </div>
                        </div>
