                                                    ...
                                                    <div class="d-flex align-items-start gap-4 nowrap">
                                                        ...
                                                        <div class="check-item">
                                                            ...
                                                            <p class="text-muted fs-12 lh-1">
                                                                {{show_currency()}}{{short_amount($data->price)}} x
                                                                {{$data->quantity}} ({{$data->attributes_value}}) </p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-end nowrap">
                                                    {{show_currency()}}{{short_amount($data->total)}}</td>
                                            </tr>
                                            @php
                                            $subTotal += ($data->total);
                                            @endphp
                                    ...
                                    <li class="table-active d-flex align-items-center justify-content-between gap-4">
                                        ...
                                        <span class="text-end pe-4 py-3 nowrap fs-14">
                                            <span id="totalamount" class="fw-bold">
                                                {{ show_currency() }}{{ number_format($subTotal -
                                                session()->get('coupon')['amount'], 2) }}
