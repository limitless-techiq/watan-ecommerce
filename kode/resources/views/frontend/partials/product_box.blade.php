...
<div class="product-item">
    <div class="product-img">
        ...
        <span class="offer-tag">{{translate('off')}} {{($product->discount_percentage)}} %</span>
        @endif
    </div>
        ...
        <div class="product-action">
            <a href="javascript:void(0)" data-product_id="{{ $randNum  }}" class="buy-now addtocartbtn">
                <span class="buy-now-icon">
                    <svg version="1.1" x="0" y="0" viewBox="0 0 511.997 511.997" xml:space="preserve">
                        <g>
                            <path
            ...
            <button data-product_id="{{$product->id}}"
                class="heart-btn product-details-love-btn wave-btn wishlistitem"><i class=" @if(in_array($product->id,$wishedProducts))
                        fa-solid
                      @else
                        fa-regular
                      @endif fa-heart"></i>
