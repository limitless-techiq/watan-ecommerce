        ...
        <form class="attribute-options-form-{{$randNum}} quick-view-form">
            ...
            <div class="product-colors">
                ...
                <div class="variant">
                    ...
                    <div class="variant-item">
                        ...
                        <label class="btn-outline-success variant-btn" for="success-outlined-{{$value}}">{{ $value
                            }}</label>
                    </div>
                    @endforeach
                </div>
            ...
            <div class="product-actions-type">
                <div class="input-step">
                    ...
                    <input type="number" data-view='quick-view' id="quantity"
                ...
                {{-- <button class="product-details-love-btn comparelist wave-btn" data-product_id="{{$product->id}}"><i
        ...
        <div class="stock-and-social">
            <div class="product-details-social">
                ...
                <div class="product-details-social-link">
                    <a href="https://www.facebook.com/sharer.php?u={{urlencode(url()->current())}}" target="__blank"><i
