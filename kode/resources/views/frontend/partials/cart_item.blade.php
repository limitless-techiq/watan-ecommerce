...
<div class="cart-products">
    ...
    <div class="cart-product">
        <div class="cart-product-img">
            <img src="{{ show_image(file_path()['product']['featured']['path'].'/'.$data->product->featured_image, file_path()['product']['featured']['size']) }}"
                alt="{{ $data->product->name }}">
        </div>
        <div class="cart-product-info">
            <h4 class="cart-product-title"><a
        ...
        <span data-id="{{ $data->id }}" class="remove-product addtocart-remove-btn remove-cart-data"><i
