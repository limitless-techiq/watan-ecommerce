                ...
                <div class="category-product">
                    <div class="product-filter-right">
                        ...
                        <div class="flex-shrink-0">
                            <div
                                class="d-flex align-items-start align-items-md-center flex-column flex-sm-row  gap-lg-5 gap-3">
                                <form action="{{route(Route::currentRouteName(),Route::current()->parameters())}}"
                                    method="GET" class="sorting-option">
                                    <div class="d-flex align-items-center gap-3">
                                        <label for="sort" class="nowrap form-label mb-0">{{translate('Sort
                                            By:')}}</label>
                                        <select name="sort_by" id="sort" class="form-select form-select-sm"
                                            aria-label=".form-select-sm example">
                                            <option value="default" @if(request()->input('sort_by') == "default")
                                                selected="" @endif>{{translate('SORT BY DEFAULT')}}</option>
                                            <option value="hightolow" @if(request()->input('sort_by') == "hightolow")
                                                selected="" @endif>{{translate('Price (High to low)')}}</option>
                                            <option value="lowtohigh" @if(request()->input('sort_by') == "lowtohigh")
                                                selected="" @endif>{{translate('Price (low to High)')}}</option>
                                        </select>
                                    </div>
                                </form>
                                    ...
                                    <div class="quick-view">
                                        <button class="quick-view-btn quick--view--product"
                                            ...
                                            <svg version="1.1" width="18" height="18" x="0" y="0"
                                                viewBox="0 0 519.644 519.644" xml:space="preserve">
                                                <g>
                                                    <path
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-action">
                                        <a href="javascript:void(0)" data-product_id="{{ $randNum  }}"
                                            ...
                                            <span class="buy-now-icon"><svg version="1.1" x="0" y="0"
